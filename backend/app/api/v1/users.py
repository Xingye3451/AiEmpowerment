...
from app.schemas.user import UserCreate, User as UserSchema, PasswordReset, PasswordResetVerify
...
async def verify_password_reset(reset_data: PasswordResetVerify, db: AsyncSession = Depends(get_db)):
    # 验证令牌并重置密码
